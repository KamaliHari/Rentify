            ...
            <div className="container">
              ...
              <div className="collapse navbar-collapse" id="navbarNav">
                <ul className="navbar-nav mx-auto">
                  ...
                  <li className="nav-item">
                    <a className="nav-link" href="/post-property">Post property</a>
                  </li>
                  <li className="nav-item">
            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-10 col-12">
                  <h1>
                    <span className="d-block text-primary">Rent out</span>
                    <span className="d-block text-dark">Your spaces</span>
                  </h1>
                </div>
              </div>
            </div>
